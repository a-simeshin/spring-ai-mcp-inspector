 ...
 * proxy handlers on the reactive stack.
 *
...
public final class InspectorSessionAttributes {
	...
	/**
	 * Exchange attribute holding the validated session-owner id (set by
	 * {@code InspectorAuthWebFilter} after the {@code X-MCP-Inspector-Auth} guard passes
	 * and the signed session cookie is resolved).
	 */

...
/**
 * Unit tests validating the honesty contract of hint annotations across all 21 demo tools
 * on the 1.x line.
 *
 * <p>
 ...
 * <li>3 tools declared with {@code readOnlyHint=false, destructiveHint=false}: askLlm,
 * askUser, deployService (the 1.x line has no {@code authorizeViaUrl} — that tool needs
 * SDK 2.0 URL-mode elicitation)</li>
...
class DemoToolHintsTests {
	...
	void hintAnnotationsMatrix() {
		...
		for (Method method : annotatedMethods) {
			...
			// All 20 annotated tools MUST have explicit annotations present

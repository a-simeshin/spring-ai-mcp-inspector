 ...
 * {@code annotations} field is then omitted from the wire entry entirely. The inspector
 * UI renders such an entry with muted "(default)" chips and the "Spec default, not
 * declared by server" tooltip, keeping the honest-hints demo path (issue #57)

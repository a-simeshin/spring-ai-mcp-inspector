...
Spring Boot 4.1, Spring AI 2.0, built with `./mvnw`.
...
```bash
# What the build job runs (Java matrix: 17 and 21)
./mvnw -B -ntp verify \
...
| Job | What it proves |
|---|---|
| `build (JDK 17)`, `build (JDK 21)` | Compiles, unit and integration tests, all quality gates |

 ...
 * Maven profile in {@code spring-ai-mcp-inspector-demo-webmvc/pom.xml}) won't fail.</li>
 * </ul>
 *
 * <p>
 ...
 *
 * <pre>{@code
 *   mvn -B -pl spring-ai-mcp-inspector-demo-webmvc -am verify -Dtest=InspectorUiIT
 * }</pre>
 */

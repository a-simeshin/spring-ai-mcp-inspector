 ...
 * transport cannot silently mask the others. Only the
 * {@code spring.ai.mcp.server.protocol} has to be forced per scenario — the web stack is
 * decided by this module's classpath, which carries the servlet stack and nothing else.
 */
@Epic("Stress & Scale")

...
import io.inspector.mcp.webmvc.McpInspectorWebMvcAutoConfiguration;
...
class AutoConfigWiringTests {
	...
	private McpInspectorWebMvcAutoConfiguration config;
	...
	void setUp() {
		...
		this.config = new McpInspectorWebMvcAutoConfiguration(properties);
	}
	...
	class ProxySessionRegistryWiring {
		...
		void autoConfigWiring_reap_invokesExchanger() {
			...
			final ProxySessionRegistry registry = AutoConfigWiringTests.this.config
				.mcpInspectorProxySessionRegistry(store, exchanger);

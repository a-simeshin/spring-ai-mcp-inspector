 ...
 * {@code io.inspector.mcp.webmvc.plain} — a package with no MCP annotations — so the
 * introspection endpoint reports an empty MCP context (R8-PLAIN v10).
 */
@SpringBootApplication
@ComponentScan(basePackages = "io.inspector.mcp.webmvc.plain")
public class PlainMcpApp {

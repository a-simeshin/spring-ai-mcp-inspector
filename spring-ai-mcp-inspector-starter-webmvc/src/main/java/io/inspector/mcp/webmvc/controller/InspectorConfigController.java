 ...
 *
 * <p>
 * The body is identical in content to the inline
 * {@code <script>window.__MCP_INSPECTOR_BOOTSTRAP = ...</script>} block injected by
...
public class InspectorConfigController {
	...
	public InspectorConfigController(InspectorBootstrapAssembler assembler) {
